...
{
    public class CatAimDownSubBehavior : CatRelaxingSubBehavior
    {
        ...
        public CatAimDownSubBehavior(RelaxPoint relaxPoint, CatComponents catComponents) : base(relaxPoint, catComponents)
        {
        ...
        {
            _catAnimator.SetAnimation(CatAnimationType.add_aim_dowm, completeCallback: TryAnotherChilling);
        }
