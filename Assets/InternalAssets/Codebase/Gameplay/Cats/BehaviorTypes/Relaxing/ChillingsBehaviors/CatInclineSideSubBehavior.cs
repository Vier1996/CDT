...
{
    public class CatInclineSideSubBehavior : CatRelaxingSubBehavior
    {
        ...
        public CatInclineSideSubBehavior(RelaxPoint relaxPoint, CatComponents catComponents) : base(relaxPoint, catComponents)
        {
        ...
        {
            _catAnimator.SetAnimation(CatAnimationType.add_incline_side, completeCallback: TryAnotherChilling);
        }
