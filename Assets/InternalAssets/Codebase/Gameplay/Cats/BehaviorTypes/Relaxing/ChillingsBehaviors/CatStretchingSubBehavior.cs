...
{
    public class CatStretchingSubBehavior : CatRelaxingSubBehavior
    {
        ...
        public CatStretchingSubBehavior(RelaxPoint relaxPoint, CatComponents catComponents) : base(relaxPoint, catComponents)
        {
        ...
        {
            _catAnimator.SetAnimation(CatAnimationType.idle_stretching, completeCallback: TryAnotherChilling);
        }
