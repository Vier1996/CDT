...
{
    public class CatPetSubBehavior : CatRelaxingSubBehavior
    {
        ...
        public CatPetSubBehavior(RelaxPoint relaxPoint, CatComponents catComponents) : base(relaxPoint, catComponents)
        {
        ...
        {
            _catAnimator.SetAnimation(CatAnimationType.action_pet, completeCallback: TryAnotherChilling);
        }
