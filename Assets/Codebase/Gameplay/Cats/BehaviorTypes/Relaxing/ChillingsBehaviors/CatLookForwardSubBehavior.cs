...
{
    public class CatLookForwardSubBehavior : CatRelaxingSubBehavior
    {
        ...
        public CatLookForwardSubBehavior(RelaxPoint relaxPoint, CatComponents catComponents) : base(relaxPoint, catComponents)
        {
        ...
        {
            _catAnimator.SetAnimation(CatAnimationType.idle_look_site, completeCallback: LaunchWorkTimer);
        }
