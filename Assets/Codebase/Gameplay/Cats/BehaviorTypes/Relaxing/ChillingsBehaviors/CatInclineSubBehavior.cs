...
{
    public class CatInclineSubBehavior : CatRelaxingSubBehavior
    {
        ...
        public CatInclineSubBehavior(RelaxPoint relaxPoint, CatComponents catComponents) : base(relaxPoint, catComponents)
        {
        ...
        {
            _catAnimator.SetAnimation(CatAnimationType.add_incline, completeCallback: TryAnotherChilling);
        }
