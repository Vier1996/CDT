...
{
    public class CatLookDownSubBehavior : CatRelaxingSubBehavior
    {
        ...
        public CatLookDownSubBehavior(RelaxPoint relaxPoint, CatComponents catComponents) : base(relaxPoint, catComponents)
        {
        ...
        {
            _catAnimator.SetAnimation(CatAnimationType.idle_look_down, completeCallback: LaunchWorkTimer);
        }
