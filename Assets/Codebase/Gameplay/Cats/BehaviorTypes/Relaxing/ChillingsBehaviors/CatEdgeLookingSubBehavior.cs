...
{
    public class CatEdgeLookingSubBehavior : CatRelaxingSubBehavior
    {
        ...
        public CatEdgeLookingSubBehavior(RelaxPoint relaxPoint, CatComponents catComponents) : base(relaxPoint,
            catComponents)
        {
        ...
        {
            _catAnimator.SetAnimation(CatAnimationType.rest_edge_idle, completeCallback: LaunchWorkTimer);
        }
